...
public class menu extends Activity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		//reportmenuflag will tell you from which page u are coming from createOrg or selectOtg
		if (reportmenuflag == true) {
			orgtype=MainActivity.orgTypeFlag;
//			Toast.makeText(context, "Type1:" +orgtype, Toast.LENGTH_SHORT).show();
			
		} else {
//			Toast.makeText(context, "OrgName:"+OrgName, Toast.LENGTH_SHORT).show();

			Object[] params = new Object[]{OrgName};
			orgtype = (String) organisation.getorgTypeByname(params, client_id);
//			Toast.makeText(context, "Type:"+orgtype, Toast.LENGTH_SHORT).show();
		}
...
//		Linkify.addLinks(s, Linkify.WEB_URLS);
		...
		description = new ArrayList<String>(Arrays.asList(
				...
				"Transfer the holdings to next financial year",
...
//				module.RunAsRoot(command);
				m.toastValidationMessage(context, "Organisation "+OrgName+" has been exported to <home>/<username>/export/");
			}
